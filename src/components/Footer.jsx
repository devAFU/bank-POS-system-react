        ...
        <div>
          <div className="flex items-center gap-3 xs:gap-5 text-lg xs:text-xl">
            <SocialMedia
              icon={<SiGithub />}
              name="github"
              link="https://github.com/KBWebExpert"
            />
            <SocialMedia
              icon={<SiLinkedin />}
              name="linkedin"
              link="https://www.linkedin.com/in/jhoan-sebastian-abad-ramirez-a868152b1/"
            />
            <SocialMedia
              icon={<SiUpwork />}
              name="upWork"
              link="https://www.upwork.com/freelancers/~011bd1b3a2df9c41ad"
            />
          </div>
        </div>
      </div>
